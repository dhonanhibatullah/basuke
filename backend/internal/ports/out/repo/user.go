...
type User interface {
	...
	UpdateUser(ctx context.Context, id int64, name *string, bio *string, preferences *json.RawMessage, by int64) (err error)
	UpdateUserRole(ctx context.Context, id int64, role domainmodel.UserRole, by int64) (err error)
